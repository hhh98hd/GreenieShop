        ...
        <>
            ...
            {!showCart ? (
                <div className="product-grid">
                    {
                        plantsArray.map((planCategory) => {
                            const plantType = planCategory.category;
                            const plants = planCategory.plants;

                            return (
                                <div key={plantType}>
                                    <div className='plant_heading'>
                                        <h2 className='plantname_heading'>{plantType}</h2>
                                    </div>
                                    <div className='product-list'>
                                        {
                                            plants.map((plant) => (
                                                <div className='product-card' key={plant.name}>
                                                    ...
                                                    <button className={!addedItems[plant.name] ? 'product-button' : 'product-button added-to-cart'} 
                                                            onClick={() => handleAddToCart(plant)} 
                                                            disabled={addedItems[plant.name]}>
                                                        {!addedItems[plant.name] ? 'Add to Cart' : 'Added to Cart'}
                                                    </button>
                                                </div>
                                            ))
                                        }
